...
export default (props) => (
    <div>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eveniet labore aliquam provident commodi officiis possimus, nemo fugit earum esse adipisci, ducimus natus illum eum, iste maxime. Laudantium, nulla! Beatae excepturi corrupti distinctio!</p>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla, repudiandae.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime, quibusdam hic dolorum minus perspiciatis vitae recusandae ratione harum neque consectetur, architecto repellendus quae!</p>
    </div>
);