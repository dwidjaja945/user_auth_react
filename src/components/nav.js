    ...
    renderLinks() {
        ...
        if (auth) {
            return (
                <Fragment>
                    <li>
                        <Link to='/secret_doc'>Secret Doc</Link>
                    </li>
                    <li>
                        <Link to='/operative_list'>Operative List</Link>
                    </li>
                    <li>
        ...
        return <li><button style={btnStyle} className='btn grey' onClick={ () => changeAuth(true) }>Sign In</button></li>
    }
